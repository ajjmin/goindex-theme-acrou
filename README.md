...
[go2index/index.js](https://github.com/ajjmin/goindex-theme-acrou/go2index) is the content of the Workers script.  
...
5. Download `index.js` in https://github.com/ajjmin/goindex-theme-acrou/tree/master/go2index and replace `client_id`,`client_secret`,`refresh_token` for what you just got.
